...
export const enTranslations = {
  ...
  'admin.activeStaffMembers': 'Active staff members',
  'admin.thisMonth': 'This month',
  'admin.scheduledThisWeek': 'Scheduled this week',
  'admin.averageFeedbackRate': 'Average feedback rate',
  'admin.schoolOverview': 'School Overview',
  'admin.schoolOverviewDesc': 'Welcome to your school administration dashboard. Here you can manage staff, view feedback analytics, and monitor the overall performance of your school.',
  'admin.schoolSettings': 'School Settings',
  'admin.schoolSettingsDesc': 'School configuration and administrative settings will be available here.',
  'admin.role': 'School Administrator',

  // Platform Admin Dashboard translations
  'platformAdmin.title': 'Platform Admin Dashboard',
  'platformAdmin.welcome': 'Welcome',
  'platformAdmin.platformAdministrator': 'Platform Administrator',
  'platformAdmin.refresh': 'Refresh',
  'platformAdmin.loading': 'Loading...',
  'platformAdmin.cleanupDemoData': 'Cleanup Demo Data',
  'platformAdmin.cleaning': 'Cleaning...',
  'platformAdmin.logout': 'Logout',
  'platformAdmin.errorLoadingData': 'Error loading data:',
  'platformAdmin.loadingDashboardData': 'Loading dashboard data...',
  'platformAdmin.totalStudents': 'Total Students',
  'platformAdmin.totalSchools': 'Total Schools',
  'platformAdmin.totalResponses': 'Total Responses',
  'platformAdmin.userManagement': 'User Management',
  'platformAdmin.analyticsReports': 'Analytics & Reports',
  'platformAdmin.gdprPrivacy': 'GDPR & Privacy',
  'platformAdmin.security': 'Security',
  'platformAdmin.schools': 'Schools',
  'platformAdmin.students': 'Students',
  'platformAdmin.doctors': 'Doctors',
  'platformAdmin.lastUpdated': 'Last updated:',
  'platformAdmin.never': 'Never',
  'platformAdmin.dataLoaded': '✓ Data loaded',
  'platformAdmin.loadingStatus': '⏳ Loading...',
  'platformAdmin.monthlyRevenue': 'Monthly Revenue:',
  'platformAdmin.activeSubscriptions': 'Active Subscriptions:',
  'platformAdmin.totalUsers': 'Total Users:',
  'platformAdmin.systemStatus': 'System Status:',
  'platformAdmin.online': '✅ Online',
  'platformAdmin.adminAccessDenied': 'Admin Access Denied',
  'platformAdmin.pleaseLoginAdmin': 'Please log in as an administrator',
  'platformAdmin.goToAdminLogin': 'Go to Admin Login',
  'platformAdmin.loadingAdminSession': 'Loading admin session...',

  // AI Insights translations
  'ai.insights': 'AI Insights',
  'ai.insightsDescription': 'Get AI-powered insights and recommendations based on student feedback and engagement data.',
  'ai.studentEngagement': 'Student Engagement Analysis',
  'ai.engagementTrends': 'Engagement Trends',
  'ai.recommendations': 'AI Recommendations',
  'ai.classPerformance': 'Class Performance Insights',
  'ai.improvementSuggestions': 'Improvement Suggestions',
  'ai.subscriptionRequired': 'A subscription is required to access AI insights.',
  'ai.subscribeToUnlock': 'Subscribe to unlock AI-powered analytics and recommendations.',
  'ai.analyzingData': 'Analyzing student feedback data...',
  'ai.noDataAvailable': 'No data available for analysis yet.',
  'ai.generateInsights': 'Generate Insights',
  'ai.lastAnalysis': 'Last analysis:',
  'ai.dataPoints': 'data points analyzed',

  // Analytics translations
  'analytics.title': 'Analytics',
  'analytics.overview': 'Analytics Overview',
  'analytics.studentFeedback': 'Student Feedback Analytics',
  ...
  'teacher.mentalHealthTab': 'Mental Health Overview',
  'teacher.mentalHealthDescription': 'Monitor student wellbeing and access mental health resources.',
