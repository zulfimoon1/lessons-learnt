          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="bg-orange-100 p-3 rounded-lg border border-orange-200">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-semibold text-orange-900">{t('weeklySummary.emotionalRoute')}</span>
              </div>
              <p className="text-orange-800 text-xs font-medium">{t('weeklySummary.emotionalDescription')}</p>
            </div>
            <div className="bg-green-100 p-3 rounded-lg border border-green-200">
              <div className="flex items-center gap-2 mb-1">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="font-semibold text-green-900">{t('weeklySummary.academicRoute')}</span>
              </div>
              <p className="text-green-800 text-xs font-medium">{t('weeklySummary.academicDescription')}</p>
            </div>
          </div>
        </CardContent>
      </Card>
