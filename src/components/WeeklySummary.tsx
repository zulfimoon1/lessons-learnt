  ...
  return (
    <Card className="bg-white/80 backdrop-blur-sm border-blue-100">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl text-gray-900">Weekly Check-In</CardTitle>
        <CardDescription className="text-lg">
          How has your week been? Share your thoughts with us.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="text-center mb-6">
            <p className="text-gray-700 font-medium">How are you feeling this week?</p>
          </div>
