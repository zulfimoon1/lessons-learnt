...
-- First, let's ensure the platform admin functions exist and work properly
...
DROP POLICY IF EXISTS "Allow public discount code validation" ON public.discount_codes;
